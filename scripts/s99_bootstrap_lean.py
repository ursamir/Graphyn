...
pm = PluginManager()
# Lean + RAG query-chain so marketplace tpl-rag-query-fs-faiss-* materialize+execute
# works under GRAPHYN_HOME=.graphyn-mcp-lean (stubs default on; no FaceRecognition/MCU).
srcs = [
    ...
    ROOT / "PluginPackage/RAG/query_rewrite",
    ROOT / "PluginPackage/RAG/vector_store_query",
    ROOT / "PluginPackage/RAG/rag_rerank",
    ROOT / "PluginPackage/RAG/contextual_compress",
    ROOT / "PluginPackage/RAG/prompt_assemble",
    ROOT / "PluginPackage/RAG/rag_generate",
    ROOT / "PluginPackage/RAG/citation_attach",

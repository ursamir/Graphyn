...
class ShipPackageCreateNode(Node):
    ...
    class Config(NodeConfig):
        ...
        project: str = Field(default='', title="Project", description="Project.")
        model_name: str = Field(default='', title="Model name", description="Model name.")
        model_stage_or_version: str = Field(default='latest', title="Model stage or version", description="Model stage or version.")
